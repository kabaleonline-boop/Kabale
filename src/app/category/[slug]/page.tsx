...
const categoryData: Record<string, { dbName: string; description: string }> = {
  'phones-tablets': { dbName: 'Phones & Tablets', description: 'The latest smartphones, tablets, and premium accessories.' },
  'computing': { dbName: 'Computing', description: 'Laptops, desktops, monitors, and professional networking gear.' },
  'home-appliances': { dbName: 'Home Appliances', description: 'TVs, refrigerators, microwaves, and daily home essentials.' },
  'hardware-tools': { dbName: 'Hardware & Tools', description: 'Construction materials, power tools, and essential hardware.' },
  'fashion': { dbName: 'Fashion', description: 'Apparel, sneakers, bags, and premium lifestyle accessories.' },
  'home-daily-items': { dbName: 'Home & Daily Items', description: 'Everyday essentials, cleaning supplies, and personal care products.' },
  'food-vegetables': { dbName: 'Food & Vegetables', description: 'Fresh farm produce, packed foods, snacks, and daily groceries.' },
};
...
export default function CategoryPage() {
  ...
  const category = categoryData[slug] || { dbName: slug, description: 'Explore items in this category.' };
